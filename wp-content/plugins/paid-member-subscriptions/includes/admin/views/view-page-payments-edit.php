 ...
 */
    ...
    $payment_id = !empty( $_GET['payment_id'] ) ? trim($_GET['payment_id']) : 0;
...
<div class="wrap">
    ...
    <form id="pms-form-edit-payment" class="pms-form" method="POST" action="<?php echo admin_url( 'admin.php?page=pms-payments-page' ); ?>">
        ...
        <div class="pms-form-field-wrapper">
            ...
            <select id="pms-payment-subscription-id" name="pms-payment-subscription-id" class="medium">
                ...
                foreach( $subscription_plans as $subscription_plan ) {
                    echo '<option ' . selected( $payment->subscription_id, $subscription_plan->id, false ) . ' value="' . $subscription_plan->id . '">' . $subscription_plan->name . '</option>';
                }
                ?>
            </select>
        ...
        <div class="pms-form-field-wrapper">
            ...
            <span class="readonly medium"><strong><?php echo $payment->discount_code; ?></strong></span>
        ...
        <div class="pms-form-field-wrapper">
            ...
            <input type="text" id="pms-payment-date" name="pms-payment-date" class="datepicker medium" value="<?php echo $payment->date; ?>" />
        ...
        <div class="pms-form-field-wrapper">
            ...
            <select id="pms-payment-type" name="pms-payment-type" class="widefat">
                ...
                foreach( $types as $type_slug => $type_name ) {
                    echo '<option ' . selected( $payment->type, $type_slug, false ) . ' value="' . $type_slug . '">' . $type_name . '</option>';
                }
                ?>
            </select>
        ...
        <div class="pms-form-field-wrapper">
            ...
            <?php if( !empty( $payment->transaction_id ) ): ?>
                <input type="text" id="pms-payment-transaction-id" name="pms-payment-transaction-id" class="widefat" value="<?php echo $payment->transaction_id; ?>" />
            <?php else: ?>
        ...
        <div class="pms-form-field-wrapper">
            ...
            <select id="pms-payment-status" name="pms-payment-status" class="medium">
                ...
                foreach( $statuses as $status_slug => $status_name ) {
                    echo '<option ' . selected( $payment->status, $status_slug, false ) . ' value="' . $status_slug . '">' . $status_name . '</option>';
                }
                ?>
            </select>
        ...
        <div class="pms-form-field-wrapper pms-form-field-ip-address">
            ...
            <span class="readonly medium"><strong><?php echo ( !empty( $payment->ip_address ) ? $payment->ip_address : '-' ); ?></strong></span>

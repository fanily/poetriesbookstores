...
<div class="wrap pms-wrap pms-info-wrap">
    ...
    <div class="pms-row pms-3-col pms-addons">
        <div>
            <h3><?php _e( 'PayPal Pro and PayPal Express', 'paid-member-subscriptions' ); ?></h3>
            <img src="<?php echo PMS_PLUGIN_DIR_URL; ?>assets/images/banner-paypal-pro-express.png" alt="PayPal Pro and PayPal Express" class="pms-addon-image" />

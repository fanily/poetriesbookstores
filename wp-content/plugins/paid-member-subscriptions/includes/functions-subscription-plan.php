 ...
 */
    ...
    function pms_get_output_subscription_plan_price( $subscription_plan ) {
        ...
        if( $subscription_plan->price == 0 )
            ...
            $price_output = pms_format_price( $subscription_plan->price, $currency_symbol, array( 'before_price' => '<span class="pms-subscription-plan-price">', 'after_price' => '</span>', 'before_currency' => '<span class="pms-subscription-plan-currency">', 'after_currency' => '</span>' ) );
        }

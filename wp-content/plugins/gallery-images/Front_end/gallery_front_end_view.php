...
.element_447 .title-block_557 .buttons-block {
	position:absolute;
	right:0px;
	top:0px;
	display:none;
		...
		<div class="element_<?php echo $galleryID; ?>" tabindex="0" data-symbol="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
			...
			<?php
				...
				?>									
							...
							<img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" src="<?php echo esc_attr(get_huge_image($imgurl[0],$image_prefix)); ?>"  />
							<?php } else { ?>
				...
				?>
							<?php
								...
								?>
										<img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo esc_attr($imgsrc); ?>"  />
								<?php
								}
							?>
				<?php
		...
		<li class="pupup-element" id="huge_it_gallery_pupup_element_<?php echo $row->id; ?>">
			...
			<div class="popup-wrapper_<?php echo $galleryID; ?>">
				<div class="image-block_<?php echo $galleryID; ?>">	
					...
					?>									
							<?php 	if($row->image_url != ';'){ ?>
							<img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-big-img<?php echo $key; ?>" src="<?php echo esc_attr($imgurl[0]); ?>"  />
							<?php } else { ?>
		...
		<div class="slider-content">
			...
			<div class="slider-content-wrapper">
				<div class="image-block_<?php echo $galleryID; ?>">
					...
					?>									
							<?php 	if($row->image_url != ';'){ ?>
							<a class="gallery_group<?php echo $galleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"><img alt="<?php echo $imgurl[0]; ?>" class="main-image" src="<?php echo esc_attr($imgurl[0]); ?>"  /></a>
							<?php } else { ?>
		...
		<div class="element_<?php echo $galleryID; ?>" tabindex="0" data-symbol="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
			<div class="image-block_<?php echo $galleryID; ?>">
				...
				?>									
							<?php $imgurl=explode(";",$row->image_url); ?>
							<?php 	if($row->image_url != ';'){ ?>
							<a href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"><img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo esc_attr(get_huge_image($imgurl[0],$image_prefix)); ?>"  /></a>
							<?php } else { ?>
							<img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" src="images/noimage.jpg"  />
							<?php
							} ?>
					...
					switch($imagerowstype){
						...
						?>
						  <li class="huge_it_slideshow_image<?php if ($i != $current_image_id) {$current_key = $key; echo '_second';} ?>_item_gallery_<?php echo $sliderID; ?>" id="image_id_gallery_<?php echo $sliderID.'_'.$i ?>">      
							...
							<img alt="<?php echo str_replace('__5_5_5__','%',$image_row->name); ?>" id="huge_it_slideshow_image_gallery_<?php echo $sliderID; ?>_<?php echo $key;?>" class="huge_it_slideshow_image_gallery_<?php echo $sliderID; ?>" src="<?php echo esc_attr($image_row->image_url); ?>" data-image_id="<?php echo $image_row->id; ?>" />
							...
							if($lkeys < $image_row->sl_url){
								...
								?>
								  <li class="huge_it_slideshow_image<?php if ($i != $current_image_id) {$current_key = $key; echo '_second';} ?>_item_gallery_<?php echo $sliderID; ?>" id="image_id_gallery_<?php echo $sliderID.'_'.$i ?>">      
									...
									<img alt="<?php echo str_replace('__5_5_5__','%',$image_row->name); ?>" id="huge_it_slideshow_image_gallery_<?php echo $sliderID; ?>" class="huge_it_slideshow_image_gallery_<?php echo $sliderID; ?>" src="<?php echo esc_attr($imagethumb[0]); ?>" data-image_id="<?php echo $image_row->id; ?>" />
			...
			<input type="hidden" id="total" value="<?=$total; ?>" />
				...
				<?php 
					...
					?>									
						...
						<img  src="<?php echo esc_attr(get_huge_image($row->image_url,$image_prefix)); ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
					<?php 
						break;
						case 'video':
					?>
				...
				<input type="hidden" id="total" value="<?=$total; ?>" />
                    ...
                    ?>
                                ...
                                <a class="gallery_group<?php echo $galleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
                                    <img  id="wd-cl-img<?php echo $key; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo esc_attr(get_huge_image($imgurl[0],$image_prefix)); ?>"/>
                                    <?php if($like_dislike != 'off'):?>
									<div class="huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>">
                            ...
                            case 'video':
                                ...
                                ?>
                                        <a class="vimeo huge_it_gallery_item gallery_group<?php echo $galleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
                                                <img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo esc_attr($imgsrc); ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
                                                <div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
                                                <?php if($like_dislike != 'off'):?>
													<div class="huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>">

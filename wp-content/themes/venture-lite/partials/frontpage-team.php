<?php if (nimbus_get_option('fp-team-toggle') == '1') { ?>
    <section id="<?php if (nimbus_get_option('fp-team-slug')=='') {echo "team";} else {echo nimbus_get_option('fp-team-slug');} ?>" class="frontpage-team">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
<?php } else if (nimbus_get_option('fp-team-toggle') == '3') {
    ...
    <section id="<?php if (nimbus_get_option('fp-team-slug')=='') {echo "team";} else {echo nimbus_get_option('fp-team-slug');} ?>" class="frontpage-team">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="team-title h1"><?php echo _e('Meet the Team', 'venture-lite' ); ?></div>
                    <div class="team-sub-title h4"><?php echo _e('Showcase the great people behind your company.', 'venture-lite' ); ?></div>
                    ...
                    <div class="row row-centered">
                        ...
                        <div class="col-sm-3 col-centered">
                            <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                                ...
                                <h4 class="team-item-title"><?php echo _e('Sally Brown', 'venture-lite' ); ?></h4>
                                <h5 class="team-item-sub-title"><?php echo _e('CEO and Chair Woman', 'venture-lite' ); ?></h5>
                       ...
                       <div class="col-sm-3 col-centered">
                            <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                                ...
                                <h4 class="team-item-title"><?php echo _e('John Smith', 'venture-lite' ); ?></h4>
                                <h5 class="team-item-sub-title"><?php echo _e('CFO and Mascot', 'venture-lite' ); ?></h5>
                                <p class="team-social-icons"><a href="#"><i class="fa fa-youtube"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-facebook"></i></a></p>
                            </div>
                        </div>           
                        ...
                        <div class="col-sm-3 col-centered">
                            <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                                ...
                                <h4 class="team-item-title"><?php echo _e('Emma Kline', 'venture-lite' ); ?></h4>
                                <h5 class="team-item-sub-title"><?php echo _e('Vice President', 'venture-lite' ); ?></h5>
                                <p class="team-social-icons"><a href="#"><i class="fa fa-youtube"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-facebook"></i></a></p>
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3 col-centered">
                            <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                                ...
                                <h4 class="team-item-title"><?php echo _e('Thomas Baggins', 'venture-lite' ); ?></h4>
                                <h5 class="team-item-sub-title"><?php echo _e('Project Manager', 'venture-lite' ); ?></h5>
                                <p class="team-social-icons"><a href="#"><i class="fa fa-youtube"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-facebook"></i></a></p>
                            </div>
                        </div> 
                    </div>    
